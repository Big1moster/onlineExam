...
from .utils import Captcha,get_captcha_text
...
class LoginView(View):
    ...
    def post(self,request):
        ...
        if not request.POST.get('vcode','').lower()==request.session.get('vcode','').lower():
            return render(request, 'login.html', {'login_form': login_form, 'vcode_error':'验证码错误'})
